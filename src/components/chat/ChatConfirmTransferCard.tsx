    ...
    <div className="flex gap-3 px-4 py-3">
      ...
      <div className="flex flex-col gap-1 max-w-[85%] flex-1">
        ...
        <div className="bg-muted rounded-2xl rounded-tl-sm p-3 space-y-3 border border-sky-200">
          <p className="text-sm">Mau transfer antar dompet ya? Cek dulu detailnya:</p>
          ...
          <div className="bg-background rounded-xl p-3 space-y-2 border border-border">
            ...
            <div className="flex items-center gap-2 pt-1 border-t border-border">
              <div className="flex-1 text-center">
                <p className="text-[10px] text-muted-foreground uppercase tracking-wide">Dari</p>
              ...
              <div className="flex-1 text-center">
                <p className="text-[10px] text-muted-foreground uppercase tracking-wide">Ke</p>
